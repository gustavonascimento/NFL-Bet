...
<html>
    ...
    <body>
        ...
        <div id="show-championship" class="content scaffold-show" role="main">
            ...
            <f:display bean="championship" />
            <g:form resource="${this.championship}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.championship}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
